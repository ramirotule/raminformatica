...
function HeroCarousel({
  ...
  const fallbackSlides: HomeSlide[] = products
    ...
    .map((p) => ({
      ...
      image_url: p.product_images!.sort(
...
export default function HomeClient({
  ...
  console.log(
    "DEBUG [HomeClient] Featured products:",
    products?.filter((p) => !!p.is_featured).length,
  );
  if (products?.length > 0) {
    console.log(
      "DEBUG [HomeClient] Sample product keys:",
      Object.keys(products[0]),
    );
    console.log(
      "DEBUG [HomeClient] Sample product is_featured:",
  ...
  return (
    <>
      ...
      <section
        className="section"
        style={{ paddingTop: 40, paddingBottom: 80, opacity: 0.8 }}
      >
        <div className="container">
          <div
            style={{
          ...
          >
            ...
            >
              Tu aliado tecnológico en Santa Rosa, La Pampa
            </h2>
            <p
              style={{
                fontSize: "0.9rem",
            ...
            >
              En RAM Informática nos especializamos en acercar lo último en
              tecnología a la Patagonia. Si estás buscando comprar una{" "}
              <strong>PlayStation</strong>, un <strong>iPhone</strong> o renovar
              tu <strong>Notebook</strong> en Santa Rosa, ofrecemos
              asesoramiento personalizado y los mejores precios del mercado.
              Nuestra trayectoria desde 2008 avala nuestro compromiso con la
              innovación y la satisfacción del cliente. Realizamos envíos
              garantizados a todo el país.
            </p>
          </div>
        </div>
      </section>
